...
def _ensure_player_on_team(
    player_id: Optional[str], team_players: List[Dict[str, Any]]
) -> bool:
    if not player_id:
        return True
...
async def set_team_roles(
    ...
    return {
        ...
        "team_roles": {
            "A": {
                "captain_id": cast(Optional[str], g.team_a_captain_id),
                "wicket_keeper_id": cast(Optional[str], g.team_a_keeper_id),
            },
            "B": {
                "captain_id": cast(Optional[str], g.team_b_captain_id),
                "wicket_keeper_id": cast(Optional[str], g.team_b_keeper_id),
            },
        },
    }
