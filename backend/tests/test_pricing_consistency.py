...
class TestScoringIsFree:
    ...
    def test_free_plan_has_zero_price(self):
        ...
        assert free_plan["monthly_usd"] == Decimal("0.00"), \
            "Free plan must cost exactly $0.00"
...
class TestPricingConsistency:
    ...
    def test_league_license_contact_only(self):
        ...
        assert pricing["monthly_usd"] is None, \
            "League license must be contact-only (None price)"
