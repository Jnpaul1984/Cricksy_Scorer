...
def test_wicket_delivery_is_recorded(api_client):
    ...
    # Create a game
    game_response = api_client.post("/games", json={
    ...
    # Set openers
    api_client.post(f"/games/{game_id}/openers", json={
    ...
    wicket_response = api_client.post(f"/games/{game_id}/deliveries", json={
...
def test_wicket_count_in_deliveries(api_client):
    ...
    for i in range(3):
        api_client.post(f"/games/{game_id}/deliveries", json={
    ...
    api_client.post(f"/games/{game_id}/next-batter", json={
        "batter_id": new_batsman_id
    })
...
def test_batsman_selection_required_after_wicket(api_client):
    ...
    next_delivery_response = api_client.post(f"/games/{game_id}/deliveries", json={
...
def test_batsman_selection_clears_pending_flag(api_client):
    ...
    # Select new batsman
    new_batsman_id = team_a_players[2]["id"]
    select_response = api_client.post(f"/games/{game_id}/next-batter", json={
        "batter_id": new_batsman_id
    })
