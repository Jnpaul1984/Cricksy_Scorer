...
class TrainingDrill:
    ...
    # Optional context
    weakness_score: float | None = None  # 0-100, how severe is weakness
    confidence: float | None = None  # 0-1, how confident is recommendation
...
class TrainingDrillGenerator:
    ...
    def generate_drills_for_player(
        ...
        player_name: str,
        player_profile: dict,
        recent_dismissals: list[dict] | None = None,
    ) -> TrainingDrillPlan:
        """
