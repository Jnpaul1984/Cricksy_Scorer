...
def test_feedback_list_auth():
    resp = client.post(
        "/tools/db/feedback.list",
        json={"since": "2025-12-01T00:00:00Z", "until": "2025-12-12T23:59:59Z"},
    )
...
def test_security_tools_shape():
    ...
    endpoints = [
        ...
        (
            "/tools/security/rate_limit_hits",
            {
                "since": "2025-12-01T00:00:00Z",
                "until": "2025-12-12T23:59:59Z",
                "groupBy": "ip",
        ...
        (
            "/tools/security/admin_route_attempts",
            {"since": "2025-12-01T00:00:00Z", "until": "2025-12-12T23:59:59Z", "limit": 10},
        ),
        (
            "/tools/security/http_4xx_5xx_summary",
            {
                "since": "2025-12-01T00:00:00Z",
                "until": "2025-12-12T23:59:59Z",
                "groupBy": "path",
