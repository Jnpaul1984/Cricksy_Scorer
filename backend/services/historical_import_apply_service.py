    ...
    *,
    ...
    phases: dict[str, Any] = {
        "historical_import": {
            ...
            "competition_code": competition_context.get("competition_code"),
            ...
            "format_category": competition_context.get("format_category"),
            "gender_category": competition_context.get("gender_category"),
            "analysis_readiness": competition_context.get("analysis_readiness"),
