...
def upgrade() -> None:
    ...
    achievement_type_enum = postgresql.ENUM(
        'century', 'half_century', 'five_wickets', 'best_scorer', 'best_bowler',
        'hat_trick', 'golden_duck', 'maiden_over', 'six_sixes', 'perfect_catch',
    ...
    op.create_index('ix_player_profiles_batting_avg', 'player_profiles', ['total_runs_scored', 'times_out'])
    ...
    op.create_table(
        ...
        sa.Column('achievement_type', sa.Enum(
            'century', 'half_century', 'five_wickets', 'best_scorer', 'best_bowler',
            'hat_trick', 'golden_duck', 'maiden_over', 'six_sixes', 'perfect_catch',
            name='achievement_type'
        ), nullable=False),
