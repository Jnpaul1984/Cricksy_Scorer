...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('tags', postgresql.ARRAY(sa.String()), nullable=True, comment='Tags like ["footwork", "timing", "technique"]'),
        sa.Column('severity', postgresql.ENUM('info', 'improvement', 'critical', name='coach_note_severity', create_type=False), nullable=False, server_default='info'),
    ...
    op.create_index('ix_coach_notes_video_session_id', 'coach_notes', ['video_session_id'], unique=False)
