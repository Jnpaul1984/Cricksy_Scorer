...
for env in td['containerDefinitions'][0]['environment']:
    if env['name'] == 'BACKEND_CORS_ORIGINS':
        env['value'] = 'https://cricksy-ai.web.app,https://app.cricksy-ai.com,https://api.cricksy-ai.com,http://localhost:5173,http://localhost:3000,http://localhost:5174,http://localhost:4173,https://cricksy-ai.com,https://www.cricksy-ai.com,https://dev.cricksy-ai.com'
