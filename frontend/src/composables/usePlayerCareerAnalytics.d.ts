...
export declare function usePlayerCareerAnalytics(): {
    summary: any;
    yearlyStats: any;
    loading: any;
    error: any;
    ...
    totalRuns: any;
    careerAverage: any;
    fetchCareerSummary: (playerId: string) => Promise<void>;
    fetchYearlyStats: (playerId: string) => Promise<void>;
    fetchFullProfile: (playerId: string) => Promise<void>;
    comparePlayers: (playerId1: string, playerId2: string) => Promise<{} | null>;
    clear: () => void;
};
