...
def prompt_message() -> str:
    ...
    return f"""
You are a senior backend+tests engineer. Diagnose failing tests for a
cricket scoring API and propose a minimal patch.
...
if __name__ == "__main__":
    ...
    raw = call_openai(prompt) if PROVIDER == "openai" else call_anthropic(prompt)
