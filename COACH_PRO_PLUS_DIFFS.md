# Coach Pro Plus Implementation - Complete Diffs

## File 1: backend/sql_app/models.py
...
## File 2: backend/services/billing_service.py
...
## File 3: backend/routes/billing.py
...
## File 5: backend/tests/test_rbac_roles.py

### Location 1: After line 186 (After test_coach_user_can_award_achievement)
...
### Location 2: At end of file (After test_org_user_can_access_coach_and_analyst_endpoints)
...
## File 6: backend/alembic/versions/add_coach_pro_plus_tier.py (NEW)
...
|-----------|---------|
| Python Enum | +1 value |
| Plan Features | +23 lines (1 new plan) |
| API Routes | +1 plan in list |
| RBAC Permissions | +1 role in decorator |
| Tests | +40 lines (2 test functions) |
| Migration | +38 lines (new file) |
...
### Verification
- ✅ RoleEnum has coach_pro_plus
- ✅ PLAN_FEATURES contains coach_pro_plus with all features
