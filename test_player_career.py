...
def test_player_career_analyzer():
    ...
    batting_records_1 = [
        {"runs": 45, "balls_faced": 32, "fours": 4, "sixes": 1, "is_out": True, "how_out": "caught"},
        {"runs": 52, "balls_faced": 38, "fours": 5, "sixes": 1, "is_out": False, "how_out": None},
        {"runs": 38, "balls_faced": 28, "fours": 3, "sixes": 1, "is_out": True, "how_out": "bowled"},
    ...
    print(f"Specialization: {summary_1['specialization']} ({summary_1['specialization_confidence']:.0%})")
    ...
    for highlight in summary_1['career_highlights']:
        print(f"  {highlight}")
    assert summary_1['specialization'] in ['Finisher', 'Batter'], f"Expected Finisher, got {summary_1['specialization']}"
    print("✅ Test 1 PASSED")
    ...
    batting_records_2 = [
        ...
        {"runs": 58, "balls_faced": 78, "fours": 5, "sixes": 0, "is_out": True, "how_out": "caught"},
        {"runs": 72, "balls_faced": 92, "fours": 7, "sixes": 0, "is_out": False, "how_out": None},
        {"runs": 51, "balls_faced": 68, "fours": 4, "sixes": 0, "is_out": True, "how_out": "bowled"},
    ...
    print(f"Specialization: {summary_2['specialization']} ({summary_2['specialization_confidence']:.0%})")
    ...
    for highlight in summary_2['career_highlights']:
        print(f"  {highlight}")
    assert summary_2['specialization'] in ['Opener', 'Batter'], f"Expected Opener, got {summary_2['specialization']}"
    print("✅ Test 2 PASSED")
    ...
    batting_records_3 = [
        {"runs": 42, "balls_faced": 50, "fours": 3, "sixes": 1, "is_out": True, "how_out": "caught"},
        ...
        {"runs": 60, "balls_faced": 65, "fours": 5, "sixes": 1, "is_out": True, "how_out": "caught"},
        {"runs": 35, "balls_faced": 40, "fours": 2, "sixes": 1, "is_out": False, "how_out": None},
        {"runs": 48, "balls_faced": 55, "fours": 3, "sixes": 1, "is_out": True, "how_out": "bowled"},
        {"runs": 55, "balls_faced": 62, "fours": 4, "sixes": 1, "is_out": False, "how_out": None},
        {"runs": 42, "balls_faced": 48, "fours": 3, "sixes": 1, "is_out": True, "how_out": "caught"},
    ...
    print(f"Specialization: {summary_3['specialization']} ({summary_3['specialization_confidence']:.0%})")
    print(f"\nBatting Stats:")
    ...
    for highlight in summary_3['career_highlights']:
        print(f"  {highlight}")
    assert summary_3['specialization'] == 'All-rounder', f"Expected All-rounder, got {summary_3['specialization']}"
    print("✅ Test 3 PASSED")
    ...
    print(f"Specialization: {summary_4['specialization']} ({summary_4['specialization_confidence']:.0%})")
    print(f"\nBowling Stats:")
    ...
    for highlight in summary_4['career_highlights']:
        print(f"  {highlight}")
    assert summary_4['specialization'] == 'Bowler', f"Expected Bowler, got {summary_4['specialization']}"
    print("✅ Test 4 PASSED")
